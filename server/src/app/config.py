...
from app.inspection_config import InspectionSettingsMixin
...
class Settings(InspectionSettingsMixin, BaseSettings):
    ...
    # Inspection behavior is defined in InspectionSettingsMixin.
